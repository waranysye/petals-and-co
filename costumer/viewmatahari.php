...
if (isset($_GET['add'])) {
    ...
    header("Location: viewmatahari.php");
    exit;
}
...
<head>
  ...
  <!-- Panggil CSS -->
 <link rel="stylesheet" href="../Assets/css/viewmatahari.css">
</head>
<body>
...
<div class="header-right">
  ...
  <div class="page-header">
    <h1>Sunflower</h1>
    <p>
      Explore our radiant collection of sunflowers, perfect for brightening someone’s day, expressing joy,
      or celebrating new beginnings. Each sunflower is handpicked and artistically arranged to capture
      the warmth and positivity of your heartfelt wishes.
    </p>
  </div>
...
<button class="btn plus" data-id="<?= $row['id']; ?>" data-action="add">+</button>
      ...
      <?php endforeach; ?>
    <?php else: ?>
      <p class="no-product">Belum ada produk Sunflower tersedia.</p>
    <?php endif; ?>
  </div>
